...
void StatisticsPage::updateStatistics()
{
    ...
    ui->labelPhasePoW->setText("PoW Hardcoded Backup Blocks - PoS  = Block 0 - " + LastPoWBlock);
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " PNK" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " PNK" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " PNK");
    }
