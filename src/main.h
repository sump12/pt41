...
public:
    ...
    {
        // steampunk: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // steampunk: get transaction coin age
...
public:
    ...
    // steampunk: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // steampunk: two types of block: proof-of-work or proof-of-stake
    ...
    // steampunk: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // steampunk: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // steampunk: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // steampunk: block index flags
    enum  
    {
